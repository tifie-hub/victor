...
function sendConfirmationEmail() {
    ...
    const studentName = document.getElementById('studentFirstName').value + ' ' + document.getElementById('studentLastName').value;
    
    console.log(`Confirmation email sent to ${email} for ${studentName}`);
...
const originalSubmitHandler = admissionForm.onsubmit;
